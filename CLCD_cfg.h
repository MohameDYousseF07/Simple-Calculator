...
/* CLCD connection mode configuration macro; Select between: 1- FOUR_BIT
 															 2- EIGHT_BIT */
#define CLCD_u8CONNECTION_MODE	FOUR_BIT

/* CLCD operation enable configuration macro; Select between: 1- ENABLED
  															  2- DISABLED */
...
#define CLCD_u8RW_PIN			DIO_PIN10
#endif
